...
v0.new("<Color=Cyan>Welcome to namdz Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(138479719318986) ;
...
v8.Image = "rbxassetid://138479719318986";
v8.Draggable = true;
